...
export declare type block_hash = Uint8Array | number[];
...
export declare type chunk_hash = Uint8Array | number[];
...
export default interface _SERVICE {
    ...
    delete_canister: ActorMethod<[{
        canister_id: canister_id;
    }], undefined>;
    deposit_cycles: ActorMethod<[{
        canister_id: canister_id;
    }], undefined>;
    ...
    start_canister: ActorMethod<[{
        canister_id: canister_id;
    }], undefined>;
    stop_canister: ActorMethod<[{
        canister_id: canister_id;
    }], undefined>;
